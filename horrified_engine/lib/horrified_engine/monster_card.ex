defmodule HorrifiedEngine.MonsterCard do
  ...
  def new(name, text, item_tokens, monsters, movement, dice, action), do:
    %MonsterCard{name: name, text: text, item_tokens: item_tokens, monsters: monsters, movement: movement, dice: dice, action: action}
